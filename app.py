...
def profile():
    return render_template(
        ...
        email=session["email"],
        age=session["age"],
        suggestion=Fitness.suggest_bmi(session["bmi"]),
        breakfast=session["breakfast"],
        lunch=session["lunch"],
        snacks=session["snacks"],
        dinner=session["dinner"],
        suggestion1=Fitness.suggest_calories_breakfast(
            session["breakfast"], session["bmi"]
        ),
        suggestion2=Fitness.suggest_calories_lunch(session["lunch"], session["bmi"]),
        suggestion3=Fitness.suggest_calories_dinner(session["dinner"], session["bmi"]),
    )
